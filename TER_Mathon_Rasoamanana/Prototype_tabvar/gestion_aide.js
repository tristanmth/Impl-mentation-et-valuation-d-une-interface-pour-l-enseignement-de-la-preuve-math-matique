...
function showAide(){
    ...
    if(text_zone == "init()"){
        ...
        ent_th_arg.push("env : environnement actuel","expr : correspond a une valeur ou à une fonction ");
        ...
        ent_th_arg.push("Indisponible !");
        ret_th.push("Indisponible !");
        ret_th_arg.push("Indisponible !");
        ent_ret_prat.push("Indisponible !");
